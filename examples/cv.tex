...
\name{Kaicheng}{Mao}
\position{Data Science Student{\enskip\cdotp\enskip}AI Research}
\address{Shenzhen, China}

\mobile{(+86) 137-9853-6656}
%\whatsapp{(+82) 10-9030-1843}
\email{12311704@mail.sustech.edu.cn}
% \homepage{your-website.com}
\github{CoryMao}
% \linkedin{\%E6\%81\%BA\%E8\%AF\%9A-\%E6\%AF\%9B-482936317}
% \gitlab{gitlab-id}
